...
const ApplicationCard: React.FC<ApplicationCardProps> = ({
  ...
  // Get the most recent rejection reason from status history if current status is rejected
  ...
  // Check if we should show interview scheduled time
  ...
  return (
    ...
    >
      <div className="p-6">
        ...
        {/* Rejection Reason - now from status history */}
        {rejectionReason && (
        ...
        {/* Interview Section - now shows for both scheduled and accepted statuses */}
        {shouldShowInterviewTime() && (
          <div className="mt-4 p-4 bg-blue-50 border border-blue-200 text-blue-800 rounded-md">
            ...
            {/* Only show action buttons if status is INTERVIEW_SCHEDULED */}
