...
function ForgetPasswordPage() {
  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      await CompanyAuthService.forgetPassword({ email });
      setShowSuccess(true);
      ...
      const parsed = handleApiError(err, "Failed to send reset link");
      ...
      <div className="w-full max-w-md px-8 py-10 bg-white rounded-xl shadow-lg">
        ...
        {serverError && (
          <div className="mb-6 p-4 bg-red-50 border-l-4 border-red-500 text-red-700 rounded">
            <div className="flex">
              <svg className="h-5 w-5 mt-1 mr-2" fill="currentColor" viewBox="0 0 20 20">
                <path
                  fillRule="evenodd"
